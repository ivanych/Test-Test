# This Makefile is for the Test::Test extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Test/Test.pm]
...
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Test/Test.pm]
#     clean => { FILES=>q[Test-Test-*] }
...
TO_INST_PM = lib/Test/Test.pm

PM_TO_BLIB = lib/Test/Test.pm \
	blib/lib/Test/Test.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  lib/Test/Test.pm $(INST_MAN3DIR)/Test::Test.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''The great new Test::Test!'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Mikhail Ivanov <m.ivanych@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Test-Test' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "The great new Test::Test!",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Mikhail Ivanov <m.ivanych@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Test-Test",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Test::Test!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Mikhail Ivanov &lt;m.ivanych@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Test/Test.pm blib/lib/Test/Test.pm 
